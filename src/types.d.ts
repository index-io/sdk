            ...
            content: {
                "application/json": {
                    ...
                    players?: {
                        ...
                        id?: string;
                        /** @description Primary industry of the client entity. Free string. */
                        industryPrimary?: string;
                        /** @description Legal name of the client entity, when it differs from the display name. */
                        legalName?: string;
                        /** @description Name of the player */
                        name: string;
                        /** @description Ownership form of the client entity. Free string. */
